...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { href: `/${locale}/projects`, label: 'Projets' },
    ...
    <footer className="border-t border-zinc-800 bg-zinc-900/50">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold text-red-500 mb-4">Boris CHENG</h3>
          ...
          {/* Social Links */}
          <div>
            <h4 className="text-white font-semibold mb-4">Me retrouver</h4>
            <div className="flex gap-4">
              {socials.map((social) => (
                <a
                  ...
                  className="p-2 rounded-lg border border-zinc-700 text-zinc-400 hover:text-red-500 hover:border-red-500 transition"
                >
